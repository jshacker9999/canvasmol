    ...
    a.widget("ui.draggable", a.ui.mouse, {
        ...
        _getRelativeOffset: function () {
            if (this.cssPosition == "relative") {
                ...
                return {
                    top: b.top - (parseInt(this.helper[0].style.top, 10) || 0) + this.scrollParent.scrollTop(),
                    left: b.left - (parseInt(this.helper[0].style.left, 10) || 0) + this.scrollParent.scrollLeft()
                }
            } else {
                return {
                    top: 0,
